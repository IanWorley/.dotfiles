...
(defvar IW/default-font-size 180)
...
(set-face-attribute 'default nil :font "Fira Code Retina" :height IW/default-font-size)
...
(use-package general
  :config
  (general-create-definer IW/leader-keys
...
(use-package org
  :hook (org-mode . IW/org-mode-setup)
  :config
  (setq org-ellipsis " ▾")
...
(defun IW/org-mode-visual-fill ()
  (setq visual-fill-column-width 100
	visual-fill-column-center-text t)
  (visual-fill-column-mode 1))

(use-package visual-fill-column
    :hook (org-mode . IW/org-mode-visual-fill))
